...
### User query prompts
Query1_user_input = "For each named merger party, list only the goods and services (including corresponding goods and services brand names, if applicable) currently sold or provided by the named merger party in Singapore. Focus the research ONLY on the specific named merger party. Avoid making any assumptions. If there is no clear information on the named merger party or the named merger party does not sell anything in Singapore, state None."
